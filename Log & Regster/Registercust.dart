// ignore_for_file: prefer_const_constructors, sized_box_for_whitespace, use_build_context_synchronously, unnecessary_new, unused_element
...
class Registercust extends StatefulWidget {
  const Registercust({super.key});

  @override
  State<Registercust> createState() => _RegistercustState();
}

class _RegistercustState extends State<Registercust> {
  ...
  //   FirebaseFirestore.instance.collection("User").doc(user?.uid).add({
  //     "Name": fullname,
  //     "email": emailAddress,
  //     "Phone": phone,
  //     "password": password,
                          ...
                          onPressed: () async {
                            if (formstate.currentState!.validate()) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                      content:
                                          Text("Enter currect Information")));
                            }
                          },
                          child: Text("Register"))),
                ],
